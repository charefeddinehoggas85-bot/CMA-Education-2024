...
export var entrepriseAvantages = [
    {
        id: 1,
...
export var entrepriseThematiques = [
...
export var entrepriseModalites = [
...
export var entrepriseTarif = "À partir de 700 € HT / Stagiaires";
