...
import { GraduationCap, Clock, MapPin, Users, CheckCircle, ArrowLeft, Download, Phone, Award } from 'lucide-react';
import Link from 'next/link';
import BrochureModal from '@/components/ui/BrochureModal';
import { getImageURL } from '@/lib/strapi';
export default function FormationDetailClient(_a) {
    var _b, _c;
    var formation = _a.formation;
    var router = useRouter();
    var _d = useState(false), isBrochureModalOpen = _d[0], setIsBrochureModalOpen = _d[1];
    // Mapping des images par ID de formation
    var getFormationImage = function (id) {
        var imageMap = {
    ...
    return (<>
      <BrochureModal isOpen={isBrochureModalOpen} onClose={function () { return setIsBrochureModalOpen(false); }} formation={formation}/>
      
      <section className="pt-36 pb-16 bg-gradient-to-br from-primary-blue to-indigo-800 text-white relative overflow-hidden">
        <img src={getImageURL(formation.imageData, getFormationImage(formation.id))} alt={formation.title} className="absolute inset-0 w-full h-full object-cover opacity-30"/>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              {formation.rncp && (<span className="bg-white/20 px-3 py-1 rounded-full text-sm">
                  {formation.rncp}
                </span>)}
            </div>
      ...
      <section className="py-12 bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {formation.duree && (<div className="text-center">
            ...
            {formation.volumeHoraire && (<div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-12">
              ...
              {formation.metierDesc && (<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              {formation.programme && (<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    {formation.programme.map(function (module, index) { return (<div key={index} className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            ...
                            {module.split(' : ')[1] && (<p className="text-sm text-gray-600">
                                {module.split(' : ')[1]}
                              </p>)}
                          </div>
                        </div>
              ...
              {formation.debouches && (<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  ...
                  <div className="bg-gradient-to-r from-primary-blue/5 to-indigo-100/50 rounded-2xl p-8">
                    <div className="grid md:grid-cols-2 gap-4">
                      {formation.debouches.map(function (debouche, index) { return (<div key={index} className="flex items-center space-x-3">
              ...
              {formation.competences2eAnnee && (<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  <h2 className="text-3xl font-montserrat font-bold text-primary-blue mb-6">
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8">
                    ...
                    <ul className="space-y-3">
                      {formation.competences2eAnnee.map(function (competence, index) { return (<li key={index} className="flex items-start space-x-3">
              ...
              {formation.modaliteEvaluation && (<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  <h2 className="text-3xl font-montserrat font-bold text-primary-blue mb-6">
                    Les modalités d'évaluation
                  </h2>
                  <div className="bg-white border border-gray-200 rounded-2xl p-8">
                    <ul className="space-y-3">
                      {formation.modaliteEvaluation.map(function (modalite, index) { return (<li key={index} className="flex items-start space-x-3">
              ...
              {formation.evaluation && (<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  <h2 className="text-3xl font-montserrat font-bold text-primary-blue mb-6">
                    Modalités d'évaluation
                  </h2>
                  <div className="bg-white border border-gray-200 rounded-2xl p-8">
                    <ul className="space-y-3">
                      {formation.evaluation.map(function (modalite, index) { return (<li key={index} className="flex items-start space-x-3">
                          <Award className="w-5 h-5 text-primary-yellow mt-1 flex-shrink-0"/>
                          <span className="text-gray-700">{modalite}</span>
                        </li>); })}
                    </ul>
              ...
              {formation.poursuiteEtudes && (<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  ...
                  <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-8">
                    ...
                    <ul className="space-y-3">
                      {formation.poursuiteEtudes.map(function (poursuite, index) { return (<li key={index} className="flex items-start space-x-3">
              ...
              {formation.poursuites && (<motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                  <h2 className="text-3xl font-montserrat font-bold text-primary-blue mb-6">
                    Poursuites d'études
                  </h2>
                  <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-8">
                    ...
                    <ul className="space-y-3">
                      {formation.poursuites.map(function (poursuite, index) { return (<li key={index} className="flex items-start space-x-3">
                          <GraduationCap className="w-5 h-5 text-indigo-600 mt-1 flex-shrink-0"/>
                          <span className="text-gray-700">{poursuite}</span>
                        </li>); })}
                    </ul>
            ...
            <div className="space-y-8">
              <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-white border border-gray-200 rounded-2xl p-6 sticky top-8">
                <h3 className="text-xl font-bold text-primary-blue mb-6">Informations pratiques</h3>
                
                <div className="space-y-4">
                  {formation.repartition && (<div>
                  ...
                  {formation.prerequis && (<div>
                      <div className="font-semibold text-gray-800 mb-2">Prérequis</div>
                      <ul className="space-y-1">
                        {formation.prerequis.map(function (prereq, index) { return (<li key={index} className="text-sm text-gray-600 flex items-start space-x-2">
                  ...
                  {formation.cout && (<div className="bg-green-50 rounded-lg p-4">
                  ...
                  {formation.certificateur && (<div>
                      ...
                      {formation.dateEnregistrement && (<div className="text-xs text-gray-500 mt-1">
                          Enregistré au RNCP en date du {formation.dateEnregistrement}
                        </div>)}
                    </div>)}
                  
                  {formation.financement && (<div className="bg-blue-50 rounded-lg p-4">
                ...
                <div className="mt-8 space-y-3">
                  <button onClick={handleCandidater} className="w-full bg-primary-blue text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                    Candidater maintenant
                  </button>
                  <button onClick={function () { return setIsBrochureModalOpen(true); }} className="w-full border border-primary-blue text-primary-blue py-3 rounded-lg font-semibold hover:bg-primary-blue/5 transition-colors flex items-center justify-center space-x-2">
                  ...
                  <div className="text-center pt-4 border-t">
                    <div className="flex items-center justify-center space-x-2 text-primary-blue">
                      ...
                      <span className="font-semibold">
                        {((_b = formation.contact) === null || _b === void 0 ? void 0 : _b.telephone) || '01 85 09 71 06'}
                      </span>
                    </div>
                    <div className="text-sm text-gray-600 mt-1">
                      Conseils personnalisés
                    </div>
                    {((_c = formation.contact) === null || _c === void 0 ? void 0 : _c.email) && (<div className="text-sm text-gray-600 mt-2">
