    ...
    <article className="pt-32 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="mb-8" aria-label="Fil d'Ariane">
          ...
          <Link 
            href="/blog" 
            className="inline-flex items-center text-primary-blue hover:text-primary-yellow transition-colors mt-4"
          >
        ...
        <div className="max-w-none">
          <div 
            className="prose prose-lg prose-headings:text-gray-900 prose-headings:font-bold prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-primary-blue prose-a:no-underline hover:prose-a:text-primary-yellow prose-strong:text-gray-900 prose-ul:text-gray-700 prose-li:text-gray-700"
              ...
              {article.relatedFormations && article.relatedFormations.length > 0 && (
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap gap-3 justify-center mb-6">
                    {article.relatedFormations.map((formation, index) => (
