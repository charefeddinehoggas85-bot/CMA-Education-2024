...
var RelatedArticles = function (_a) {
    var currentId = _a.currentId;
    var currentArticle = blogArticles.find(function (a) { return a.id === parseInt(currentId); });
    // Sélectionner 3 articles similaires (même catégorie ou articles récents)
    var relatedArticles = blogArticles
        .filter(function (article) { return article.id !== parseInt(currentId); })
    ...
    return (<section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {relatedArticles.map(function (article) { return (<article key={article.id} className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden hover:-translate-y-2">
