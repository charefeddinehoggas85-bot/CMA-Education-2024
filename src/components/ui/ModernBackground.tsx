...
interface ModernBackgroundProps {
  variant?: 'construction' | 'digital' | 'sustainable' | 'innovation'
  className?: string
}
...
const ModernBackground = ({ variant = 'construction', className = '' }: ModernBackgroundProps) => {
    ...
    return (
      <div className={`absolute inset-0 overflow-hidden ${className}`}>
        <div 
          ...
          style={{
            background: `
              radial-gradient(circle at 20% 80%, ${colors.primary}22 0%, transparent 50%),
              radial-gradient(circle at 80% 20%, ${colors.secondary}22 0%, transparent 50%),
              radial-gradient(circle at 40% 40%, ${colors.accent}15 0%, transparent 50%)
            `
          }}
        />
      </div>
    ...
    <div className={`absolute inset-0 overflow-hidden ${className}`}>
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1000 1000">
        ...
        {variant === 'construction' && (
          <>
            <motion.rect
              x="100" y="200" width="800" height="4"
              fill={colors.primary}
              opacity="0.2"
            ...
            />
            <motion.rect
              x="200" y="100" width="4" height="600"
        ...
        {[...Array(12)].map((_, i) => {
          ...
          const points = `${x},${y} ${x+30},${y+20} ${x+30},${y+60} ${x},${y+80} ${x-30},${y+60} ${x-30},${y+20}`
          return (
            <motion.polygon
              key={i}
              points={points}
