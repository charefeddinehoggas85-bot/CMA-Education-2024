...
var FloatingActions = function () {
    var actions = [
        ...
        },
        {
            ...
            onClick: function () { return console.log('Ouvrir le chat'); }
        },
        {
            icon: <AnimatedIcon variant="float" size="sm"><Calendar className="w-5 h-5"/></AnimatedIcon>,
            label: "Prendre RDV",
            onClick: function () { return console.log('Prendre rendez-vous'); }
        },
        {
            icon: <AnimatedIcon variant="rotate" size="sm"><Download className="w-5 h-5"/></AnimatedIcon>,
            label: "Télécharger brochure",
            onClick: function () { return console.log('Télécharger brochure'); }
        }
    ];
    return (<FloatingActionButton actions={actions} mainIcon={<AnimatedIcon variant="pulse" size="md"><MessageCircle className="w-6 h-6"/></AnimatedIcon>} position="bottom-right" size="lg" variant="gradient"/>);
};
