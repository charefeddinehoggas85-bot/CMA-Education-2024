...
var Footer = function () {
    ...
    var _g = useState(null), siteSettings = _g[0], setSiteSettings = _g[1];
    var _h = useState(true), loading = _h[0], setLoading = _h[1];
    useEffect(function () {
        function loadData() {
            return __awaiter(this, void 0, void 0, function () {
                var _a, statsData, settingsData, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _a = _b.sent(), statsData = _a[0], settingsData = _a[1];
                            console.log('📊 Données Strapi chargées:', { statsData: statsData, settingsData: settingsData });
                            setStats(statsData);
                            setSiteSettings(settingsData);
                            return [3 /*break*/, 4];
                        case 2:
                            error_1 = _b.sent();
                            console.warn('⚠️ Erreur Strapi, utilisation des données de fallback:', error_1);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex flex-col items-start space-y-3 md:space-y-4 mb-6">
                <div className="bg-white rounded-lg p-2 w-full max-w-[200px]">
                  <img src="/images/Qualuipo.webp" alt="Qualuipo" className="h-16 md:h-20 lg:h-24 w-full object-contain"/>
                </div>
                <div className="bg-white rounded-lg p-2 w-full max-w-[200px]">
                  <img src="/images/logoo.svg" alt={(siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.siteName) || "Construction Management Academy"} className="h-16 md:h-20 lg:h-24 w-full object-contain"/>
                </div>
              </div>
              ...
              {loading ? (<div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8">
                  {[1, 2, 3].map(function (i) { return (<div key={i} className="text-center bg-white/10 backdrop-blur-sm rounded-xl p-3 md:p-4 animate-pulse">
                      <div className="h-5 md:h-6 bg-gray-300 rounded mb-2"></div>
                      <div className="h-2 md:h-3 bg-gray-300 rounded"></div>
                    </div>); })}
                </div>) : (<div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8">
                  {stats.slice(0, 3).map(function (stat) { return (<div key={stat.id} className="text-center bg-white/10 backdrop-blur-sm rounded-xl p-3 md:p-4">
              ...
              <div className="flex flex-wrap gap-2 md:gap-3 justify-center md:justify-start">
                {((_a = siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.socialMedia) === null || _a === void 0 ? void 0 : _a.facebook) && (<Link href={siteSettings.socialMedia.facebook} className="w-11 h-11 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-primary-yellow hover:text-primary-blue transition-all duration-300 group">
                    <Facebook className="w-5 h-5"/>
                  </Link>)}
                {((_b = siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.socialMedia) === null || _b === void 0 ? void 0 : _b.instagram) && (<Link href={siteSettings.socialMedia.instagram} className="w-11 h-11 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-primary-yellow hover:text-primary-blue transition-all duration-300 group">
                ...
                {((_c = siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.socialMedia) === null || _c === void 0 ? void 0 : _c.tiktok) && (<Link href={siteSettings.socialMedia.tiktok} className="w-11 h-11 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-primary-yellow hover:text-primary-blue transition-all duration-300 group">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                    </svg>
                  </Link>)}
                {((_d = siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.socialMedia) === null || _d === void 0 ? void 0 : _d.youtube) && (<Link href={siteSettings.socialMedia.youtube} className="w-11 h-11 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-primary-yellow hover:text-primary-blue transition-all duration-300 group">
                    <Youtube className="w-5 h-5"/>
                  </Link>)}
                {((_e = siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.socialMedia) === null || _e === void 0 ? void 0 : _e.linkedin) && (<Link href={siteSettings.socialMedia.linkedin} className="w-11 h-11 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center hover:bg-primary-yellow hover:text-primary-blue transition-all duration-300 group">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-3">
                {quickLinks.map(function (link) { return (<Link key={link.name} href={link.href} className="block text-gray-300 hover:text-white font-medium transition-colors duration-200 hover:translate-x-1 transform">
                    {link.name}
                  </Link>); })}
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-4 mb-8">
                {(siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.contactPhone) && (<Link href={"tel:".concat(siteSettings.contactPhone.replace(/\s/g, ''))} className="flex items-center space-x-3 text-gray-300 hover:text-white transition-all duration-200 group">
                ...
                {(siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.contactEmail) && (<Link href={"mailto:".concat(siteSettings.contactEmail)} className="flex items-center space-x-3 text-gray-300 hover:text-white transition-all duration-200 group">
                    <div className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center group-hover:bg-primary-yellow group-hover:text-primary-blue transition-all duration-200">
                ...
                {(siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.contactAddress) && (<div className="flex items-start space-x-3 text-gray-300">
            ...
            <div className="lg:col-span-1">
              <OptimizedGoogleMap address={(siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.contactAddress) || "67-69 Avenue du Général de Gaulle, 77420 Champs sur Marne"}/>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto px-6 py-6">
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
              <p className="text-sm text-gray-400 font-medium">
                &copy; 2024 {(siteSettings === null || siteSettings === void 0 ? void 0 : siteSettings.siteName) || "Construction Management Academy"}
              </p>
