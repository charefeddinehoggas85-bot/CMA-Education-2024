...
export function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, nom, email, telephone, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    body = _a.sent();
                    nom = body.nom, email = body.email, telephone = body.telephone;
                    // Validation
                    if (!nom || !email || !telephone) {
                        return [2 /*return*/, NextResponse.json({ error: 'Tous les champs sont requis' }, { status: 400 })];
                    }
                    // TODO: Sauvegarder dans votre base de données
                    // TODO: Envoyer un email de confirmation
                    // TODO: Envoyer la brochure par email à contact.academy@cma-education.com
                    console.log('Nouvelle demande de brochure:', { nom: nom, email: email, telephone: telephone, date: new Date() });
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Erreur API brochure:', error_1);
