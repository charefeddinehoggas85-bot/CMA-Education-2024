...
export default function JourneePorteOuvertePage() {
    return (<div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSdHNGeoFvaaeknFrtrgIaUe7yDxS1fm0JiYo7q-bxetbfeOiQ/viewform?pli=1" target="_blank" rel="noopener noreferrer" className="bg-white text-primary-blue px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-colors inline-flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105">
                <span>S'inscrire maintenant</span>
                <ArrowRight className="w-4 h-4"/>
              </a>
              
              <Link href="#programme" className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-primary-blue transition-colors">
                Voir le programme
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-50">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            { date: "Samedi 12 Avril 2026", day: "Samedi", month: "Avril", dayNum: "12" }
        ].map(function (dateInfo, index) { return (<div key={index} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                  <div className="text-center">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSdHNGeoFvaaeknFrtrgIaUe7yDxS1fm0JiYo7q-bxetbfeOiQ/viewform?pli=1" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 bg-gradient-to-r from-primary-blue to-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg">
            ...
            <div className="text-center">
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSdHNGeoFvaaeknFrtrgIaUe7yDxS1fm0JiYo7q-bxetbfeOiQ/viewform?pli=1" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-xl font-bold hover:from-orange-600 hover:to-red-600 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
      ...
      <section className="py-20 bg-white">
        ...
        ].map(function (formation, index) { return (<div key={index} className="bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-shadow">
                  <div className={"w-12 h-12 bg-gradient-to-r ".concat(formation.color, " rounded-xl flex items-center justify-center mb-4")}>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/formations" className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-primary-blue transition-colors inline-flex items-center justify-center space-x-2">
