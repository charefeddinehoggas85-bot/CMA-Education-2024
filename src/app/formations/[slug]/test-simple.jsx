...
export default function TestSimplePage() {
    ...
    useEffect(function () {
        function loadFormation() {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var response, data, formationData, transformed, err_1;
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        case 0:
                            console.log('🚀 Test simple - Début loadFormation, slug:', slug);
                            _l.label = 1;
                        case 1:
    ...
    if (!formation) {
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-2">Aucune formation trouvée pour ce slug</p>
          <p className="text-sm text-gray-500">Slug: {slug}</p>
        </div>
      </div>);
    }
