...
import { RefreshCw, ArrowRight, CheckCircle, Target } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-gray-50 rounded-2xl p-8">
              ...
              <ul className="space-y-3">
                {objectifs.map(function (objectif, index) { return (<li key={index} className="flex items-start space-x-3">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {debouches.map(function (debouche, index) { return (<motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className="bg-gradient-to-br from-green-600 to-emerald-600 text-white rounded-xl p-6 text-center">
